...
src="https://www.youtube.com/embed/XBuTjIBjQOA">
    ...
    <section class="why">
        <header>
            ...
            <a href="about" id="read">Read more</a>
        </header>
        <main>
    ...
    <section class="three">
        <header>
         ...
         <a href="event" id="fulldet"><img src="./images/arrow right.png" alt="" id="evearr"> View Full Details of Blockchain conference 2.0</a>
        <header>
            <hr>
            <h1>
                FEATURED EVENTS
  ...
  <section class="teamsec">
    ...
    <article class="cfs">
        <main class="teaml">
            <img src="./images/NK1_0709muy 2.png" alt="" class="photo" id="nduka">
            <div class="cfst">
    ...
    <article class="cfs">
        ...
        <main class="otherst">
            ...
            <h4>
              <a href="team">  Other team members </a><img src="./images/arrow right.png" alt="">
            </h4>
        </main>
    </article>
    </section>
